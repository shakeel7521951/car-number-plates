    ...
    <main>
      <div className='relative'>
        ...
        <div className='absolute top-[30%] left-12'>
          ...
          <p className='text-white mt-3 text-xl'>Buy & Sell Your Number <br /> Plates</p>
          <button className='border p-2 rounded-xl bg-transparent mt-3 text-white'>Get Started</button>
        </div>
      </div>
