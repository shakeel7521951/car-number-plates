...
const HomeCards = () => {
    ...
    return (
        <div className='mt-5 p-10'>
            <h1 className='text-white text-center text-[30px] md:text-[40px] font-bold'>New Today</h1>
            ...
            <div className='flex justify-center mx-auto'>
                <Link to="/explore" className='text-center bg-[#1DE678] font-bold text-black rounded-xl mt-5 px-4 py-2 hover:bg-[#1da65a] transition-all'>
                    Explore More
                </Link>
            </div>
