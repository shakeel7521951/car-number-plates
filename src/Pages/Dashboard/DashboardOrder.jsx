...
const DashboardOrder = () => {
  ...
  return (
    <div className="w-[90%]   mx-auto">
      <h1 className="text-xl font-semibold mb-4 lg:text-left text-center">Orders</h1>
      ...
      <div className=" ">
        ...
        <div className="overflow-x-auto">
          ...
          <div className="min-w-[700px] bg-white rounded-3xl shadow-lg shani p-2  ">
            {/* Header */}
            <div className="grid grid-cols-8 gap-1 bg-gray-100 rounded-xl border-[1px] border-black">
