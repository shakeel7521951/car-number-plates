...
const DashboardPayment = () => {
  ...
  const orders = [
    { id: 1, title: 'Send', count: 1925, startColor: '#432ab1' },
    { id: 2, title: 'Receive', count: 450, startColor: '#e70000' },
    { id: 3, title: 'Pending', count: 1480, startColor: '#d3b144' },
    { id: 4, title: 'Balance', count: 72, startColor: '#053d26' },
  ];
  ...
  {order.status}
      ...
      <h1 className='text-xl font-semibold my-4'>Payments History</h1>
