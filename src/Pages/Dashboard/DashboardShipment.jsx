...
const DashboardShipment = () => {
  ...
  const data = [
    { id: 1, count: 130, label: 'New Orders', icon: StoreIcon },
    { id: 2, count: 80, label: 'In Process', icon: setting },
    { id: 3, count: 200, label: 'Delivery', icon: van },
    { id: 4, count: 50, label: 'Total Delivery', icon: van },
  ];
    ...
    <div className='w-[82%] mx-auto'>
      ...
      <div className='bg-white rounded-3xl shadow-lg overflow-hidden p-2'>
        ...
        <div className='grid grid-cols-8 bg-gray-100 rounded-xl border-[1px] border-black'>
          ...
          <div className='p-4 font-medium'>Delivery Status</div>
